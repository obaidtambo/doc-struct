...
import { AnalyzedParagraph, ViewType } from '../types';
...
const DownloadMenu: React.FC<DownloadMenuProps> = ({ data, activeView, svgElement }) => {
  ...
  const handleDownloadCSV = () => {
    const headers = ['id', 'parentId', 'level', 'role', 'content', 'enrichment', 'pageNumber'];
    const csvRows = [
      headers.join(','),
      ...data.map(row => {
